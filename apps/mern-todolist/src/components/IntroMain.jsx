...
const IntroMain = () => {
  return (
    <div className='' >
      <div className='grid grid-cols-4 gap-4 bg-customblue pb-6'
        >
        <div className='lg:col-span-2 col-span-full'>
          <div className='ml-10  '>
            ...
            <div className='bg-cardBg rounded-xl border-borderColor border-8 w-4/5	 py-5 px-6 mt-5 mb-7 mr-6 lg:mr-0'>
              ...
              <div className='grid grid-cols-6 gap-5'>
                <div className='lg:col-span-4 col-span-full'>
                  <ul className='flex justify-center lg:justify-start items-center gap-6'>
                    ...
                    <li style={{borderBottomLeftRadius: '50px'}} className='bg-bgRed rounded flex justify-center w-10 h-5'></li>
                    <li style={{borderBottomLeftRadius: '50px'}} className='bg-bgRed rounded flex justify-center  w-10 h-5'></li>
                    <li style={{borderBottomLeftRadius: '50px'}} className='bg-dayGrayBg rounded flex justify-center  w-10 h-5'></li>
                  </ul>
                </div>
                <div className='lg:col-span-2 col-span-full justify-self-center lg:justify-self-end'>
                  <h3 className='text-customblue font-normal text-2xl'>Task Name</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='col-span-full lg:col-span-2'>
          <img className='bg-contain bg-no-repeat bg-right' src={bg}  alt="" />
        </div>
      </div>
    </div>
  )
